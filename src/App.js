  ...
  return (
    <div className="container">
      ...
      <div className="content">
        <p><strong>Data:</strong> 22.05.2024</p>
        ...
        <p>2- A promoção só é válida a partir do dia 22 de maio de 2024, por tempo indeterminado, até que a empresa comunique o encerramento da mesma;</p>
