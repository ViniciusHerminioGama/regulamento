  ...
  return (
    <div className="container">
      ...
      <div className="content">
        ...
        <p>4- O número de indicações é ilimitada, porém os descontos são limitados ao valor concedido por 1 (uma) indicação por mês, com limite de R$50,00;</p>
        <p>5- O desconto gerado é para o titular do contrato, indicado no formulário, não podendo ser transferido para outro cliente;</p>
        <p>6- Não é permitido ressarcimento em valor (dinheiro) ao cliente, o benefício é apenas desconto em mensalidades e limitado ao serviço de conexão à internet;</p>
      </div>
    </div>
  );
}
